...
class TestingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testing" do
    assert_difference("Testing.count") do
      post testings_url, params: { testing: { bio: @testing.bio, username: @testing.username } }
    end
  ...
  test "should update testing" do
    patch testing_url(@testing), params: { testing: { bio: @testing.bio, username: @testing.username } }
